...
# built documents.
project_version = __import__('opcgui').__version__.split('.')
...
latex_documents = [
    (master_doc, 'opcgui.tex', 'OpenCAL GUI Documentation',
     authors, 'manual'),
]
...
man_pages = [
    (master_doc, 'opcgui', 'OpenCAL GUI Documentation',
     [authors], 1)
]
...
texinfo_documents = [
    (master_doc, 'opcgui', 'OpenCAL GUI Documentation',
     authors, 'opcgui', 'Opencal Python GUI.',
     'Miscellaneous'),
]
